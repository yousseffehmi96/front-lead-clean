...
export default function GoldPage() {
  ...
  const handleTableClick = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    if (type === "verify-email") handleVerifyEmail(id, decodeURIComponent(btn.dataset.email || ""))
